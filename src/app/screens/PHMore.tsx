/**
 * PH-50 More — Pharmacist "More" menu (light).
 * Today's Summary, Profile, Help Center, Privacy Policy, Sign Out.
 * Main navigation tab (More). Shows PharmacyBottomNav.
 */
  ...
  const profileItems: MenuItem[] = [
    {
      id: 'profile',
      label: 'My Profile',
      subtitle: 'Pharmacist Lule — Pharmacy',
  ...
  const pharmacyItems: MenuItem[] = [
    {
      ...
      subtitle: `${stats.completed} dispensed, ${stats.newCount + stats.inProgress} active`,
      ...
      <div className="flex-1 overflow-y-auto pb-20">
        <div className="p-4 space-y-4">
          ...
          <p className="text-center text-xs text-[#8F9AA1] pt-2">
            ABA Partner v1.0.0 &middot; Pharmacy
          </p>
        </div>
      </div>
