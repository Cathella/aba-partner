/**
 * PHConfirmModal — Confirmation modal for Pharmacist actions.
 * Used for: Dispense, Put on Hold, Complete, Out of Stock, etc.
 */

import { ABAButton } from './ABAButton';

interface PHConfirmModalProps {
  isOpen: boolean;
  onClose: () => void;
...
export function PHConfirmModal({
  isOpen,
  onClose,
  icon,
  iconBg = 'bg-[#EBF3FF]',
